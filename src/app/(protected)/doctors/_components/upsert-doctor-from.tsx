...
const formSchema = z
  .object({
    ...
    appointmentPrice: z.number().min(1, {
      message: "Preço da cosunta é obrigatório.",
    }),
...
const UpsertDoctorFrom = ({ doctor, onSuccess }: UpsertDoctorFormProps) => {
                ...
                >
                  ...
                  <SelectContent>
                    {medicalSpecialties.map((specialty) => (
                      <SelectItem
                        key={specialty.values}
                        value={specialty.values}
                      >
                        {specialty.label}
                      </SelectItem>
                    ))}
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      ...
                      médico e todas aasconsultas agendadas.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
...
export default UpsertDoctorFrom;
